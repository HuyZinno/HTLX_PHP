...
// Sử dụng giá trị $tongTien được truyền từ trang HTML trước đó
$tongTien = $_POST['tongTien']; // Đảm bảo rằng giá trị này được truyền dưới dạng POST
$orderId = time() . "";
$redirectUrl = "http://localhost/HTLX/app/views/hoaDon.php";
$ipnUrl = "http://localhost/HTLX/app/views/hoaDon.php";
$extraData = "";
...
$data = array('partnerCode' => $partnerCode,
    ...
    'requestId' => $requestId,
    'amount' => $tongTien, // Sử dụng giá trị $tongTien ở đây
    'orderId' => $orderId,
    'orderInfo' => $orderInfo,
